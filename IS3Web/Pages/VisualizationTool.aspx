...
<head id="Head1" runat="server">
	...
	<script src="../Scripts/AdvancedCalculator.js" type="text/javascript"></script>
</head>
<body>
    ...
    <div id="divChart" class="divChart">
		...
		<td style="width:8%;"></td>
		<td style="float:center;"><input type="range" name="zoomSlider" id="zoomSlider" class="zoomSlider" value="0" min="0" max="100" /></td>
    ...
    <div id="divMenu" class="divMenu">
	    ...
	    <table><tr><td width="35%">
		    ...
		    <label for="selectAllColumns">Select all</label></td><td width="40%"></td><td width="50%">
	<a href="#" style="float:right;" class="advancedButton" id="advancedButton" data-role="button"data-icon="plus"> Add custom attribute</a></td></tr></table>
        </div>
        <div class="clear">
        </div>
