function generateColumns() {
    ...
    var jqmBottom2 = "</span><span class=\"ui-icon ui-icon-checkbox-off ui-icon-shadow\"> </span></span></label></div>";
    var uiSelector = $('.ulColumns');
    var invSlider1 = "<div class=\"invSlider\"><select name=\""; //style=\"float: right; \"
    var invSlider2 = "\" id=\"";
    var invSlider3 = "\" data-role=\"slider\" class=\"invSlider ui-slider-switch\" data-mini=\"true\"><option value=\"off\">Off</option>";
    var invSlider4 = "<option value=\"on\">On</option></select></div>"; //close div
